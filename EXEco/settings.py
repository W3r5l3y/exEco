"""
Django settings for EXEco project.
...
DEBUG = True
ALLOWED_HOSTS = ["execo-production.up.railway.app", "127.0.0.1"]
...
WSGI_APPLICATION = "EXEco.wsgi.application"
