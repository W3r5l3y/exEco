...
class LoggedActivity(models.Model):
    ...
    activity_type = models.CharField(max_length=20, choices=[("run", "Run"), ("ride", "Ride"), ("walk", "Walk")]) # Run or ride or walk
    option = models.CharField(max_length=20, choices=[("commute", "Commute"), ("hobby", "Hobby")]) # Commute or hobby
